...
public class Context {
	...
	private String defaultConfigPath = "/conf.conf";
	...
	private String help = "usage: java -jar ./heavy_client.jar [options]\n"
			+ "\n"
			+ "options:\n"
			+ "-client_port       PORT_NUMBER (8521)\n"
			+ "-server_port       PORT_NUMBER (8520)\n"
			+ "-server_ip         SERVER_IP   (127.0.0.1)\n"
			+ "-client_ip         CLIENT_IP   (0.0.0.0)\n"
			+ "-run_test_server   DIRECTORY   set the directory where simulateServer.py is\n"
			+ "--run_test_server  (runs the simulateServer.py script assuming its into \"test\" directory)\n" ;
